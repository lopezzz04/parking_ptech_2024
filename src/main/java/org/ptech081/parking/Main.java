...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Creo el registro
         ...
         Registro registro2 = new Registro( fechaInicio , horaInicio , fechaFin , horaFin , 50000L , cupo2 , cliente1.misCarros.get(0) , cliente1);
         ...
         for(Registro r : misRegistros){
            ...
            System.out.println("Cliente:" + r.cliente.nombres + " " + r.cliente.apellidos + "|" + r.carro.placa + " " + r.carro.tipoVehiculo + "|" + r.valor + "|" + r.fechaInicio + "|" + r.horaInicio + "|");
